...
\begin{figure}[h]
    \begin{mathpar}
        ...
        \inferrule*[left=type-seq]{
            ...
            \Gamma \vdash e_1 \cseq e_2: A_N, A_B, A_C, A_R
        }
        \and
        \inferrule*[left=type-if]{
            ...
            \Gamma \vdash \cif e_1 \cthen e_2 \celse e_3: A_N, A_B, A_C, A_R
        }
        \and
