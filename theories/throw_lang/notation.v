...
(* Notation "'loop' e" := (LoopB e e) (at level 200) : expr_scope.
Notation "'break' e" := (EBreak e) (at level 200) : expr_scope.
Notation "'continue'" := EContinue (at level 200) : expr_scope.
Notation "'call' e" := (Call e) (at level 200) : expr_scope.
Notation "'return' e" := (EReturn e) (at level 200) : expr_scope. *)
